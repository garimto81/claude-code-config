# GitHub-Native Workflow Quick Start
...
## Step 3: Issue Templates 추가 (이미 완료)
...
**참고**: `docs/GITHUB_NATIVE_WORKFLOW.md`의 전체 워크플로우 예제
...
3. **GitHub Actions 추가**: 자동 테스트 & 배포 (상세: `docs/GITHUB_NATIVE_WORKFLOW.md`)
...
- **상세 가이드**: `docs/GITHUB_NATIVE_WORKFLOW.md`
